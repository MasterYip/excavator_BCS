...
namespace cartographer_ros_msgs
{
  ...
  class TrajectoryOptions : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_num_point_clouds.base >> (8 * 3)) & 0xFF;
      ...
      union {
        double real;
        uint64_t base;
      } u_rangefinder_sampling_ratio;
      u_rangefinder_sampling_ratio.real = this->rangefinder_sampling_ratio;
      *(outbuffer + offset + 0) = (u_rangefinder_sampling_ratio.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_rangefinder_sampling_ratio.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_rangefinder_sampling_ratio.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_rangefinder_sampling_ratio.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_rangefinder_sampling_ratio.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_rangefinder_sampling_ratio.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_rangefinder_sampling_ratio.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_rangefinder_sampling_ratio.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->rangefinder_sampling_ratio);
      union {
        double real;
        uint64_t base;
      } u_odometry_sampling_ratio;
      u_odometry_sampling_ratio.real = this->odometry_sampling_ratio;
      *(outbuffer + offset + 0) = (u_odometry_sampling_ratio.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_odometry_sampling_ratio.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_odometry_sampling_ratio.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_odometry_sampling_ratio.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_odometry_sampling_ratio.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_odometry_sampling_ratio.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_odometry_sampling_ratio.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_odometry_sampling_ratio.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->odometry_sampling_ratio);
      union {
        double real;
        uint64_t base;
      } u_fixed_frame_pose_sampling_ratio;
      u_fixed_frame_pose_sampling_ratio.real = this->fixed_frame_pose_sampling_ratio;
      *(outbuffer + offset + 0) = (u_fixed_frame_pose_sampling_ratio.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_fixed_frame_pose_sampling_ratio.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_fixed_frame_pose_sampling_ratio.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_fixed_frame_pose_sampling_ratio.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_fixed_frame_pose_sampling_ratio.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_fixed_frame_pose_sampling_ratio.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_fixed_frame_pose_sampling_ratio.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_fixed_frame_pose_sampling_ratio.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->fixed_frame_pose_sampling_ratio);
      union {
        double real;
        uint64_t base;
      } u_imu_sampling_ratio;
      u_imu_sampling_ratio.real = this->imu_sampling_ratio;
      *(outbuffer + offset + 0) = (u_imu_sampling_ratio.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_imu_sampling_ratio.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_imu_sampling_ratio.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_imu_sampling_ratio.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_imu_sampling_ratio.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_imu_sampling_ratio.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_imu_sampling_ratio.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_imu_sampling_ratio.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->imu_sampling_ratio);
      union {
        double real;
        uint64_t base;
      } u_landmarks_sampling_ratio;
      u_landmarks_sampling_ratio.real = this->landmarks_sampling_ratio;
      *(outbuffer + offset + 0) = (u_landmarks_sampling_ratio.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_landmarks_sampling_ratio.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_landmarks_sampling_ratio.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_landmarks_sampling_ratio.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_landmarks_sampling_ratio.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_landmarks_sampling_ratio.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_landmarks_sampling_ratio.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_landmarks_sampling_ratio.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->landmarks_sampling_ratio);
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_rangefinder_sampling_ratio.base = 0;
      u_rangefinder_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_rangefinder_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_rangefinder_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_rangefinder_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_rangefinder_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_rangefinder_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_rangefinder_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_rangefinder_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->rangefinder_sampling_ratio = u_rangefinder_sampling_ratio.real;
      offset += sizeof(this->rangefinder_sampling_ratio);
      union {
        double real;
        uint64_t base;
      } u_odometry_sampling_ratio;
      u_odometry_sampling_ratio.base = 0;
      u_odometry_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_odometry_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_odometry_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_odometry_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_odometry_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_odometry_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_odometry_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_odometry_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->odometry_sampling_ratio = u_odometry_sampling_ratio.real;
      offset += sizeof(this->odometry_sampling_ratio);
      union {
        double real;
        uint64_t base;
      } u_fixed_frame_pose_sampling_ratio;
      u_fixed_frame_pose_sampling_ratio.base = 0;
      u_fixed_frame_pose_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_fixed_frame_pose_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_fixed_frame_pose_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_fixed_frame_pose_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_fixed_frame_pose_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_fixed_frame_pose_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_fixed_frame_pose_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_fixed_frame_pose_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->fixed_frame_pose_sampling_ratio = u_fixed_frame_pose_sampling_ratio.real;
      offset += sizeof(this->fixed_frame_pose_sampling_ratio);
      union {
        double real;
        uint64_t base;
      } u_imu_sampling_ratio;
      u_imu_sampling_ratio.base = 0;
      u_imu_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_imu_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_imu_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_imu_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_imu_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_imu_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_imu_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_imu_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->imu_sampling_ratio = u_imu_sampling_ratio.real;
      offset += sizeof(this->imu_sampling_ratio);
      union {
        double real;
        uint64_t base;
      } u_landmarks_sampling_ratio;
      u_landmarks_sampling_ratio.base = 0;
      u_landmarks_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_landmarks_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_landmarks_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_landmarks_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_landmarks_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_landmarks_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_landmarks_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_landmarks_sampling_ratio.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->landmarks_sampling_ratio = u_landmarks_sampling_ratio.real;
      offset += sizeof(this->landmarks_sampling_ratio);
